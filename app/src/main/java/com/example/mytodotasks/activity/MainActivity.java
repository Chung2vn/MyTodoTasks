package com.example.mytodotasks.activity;
...
import com.example.mytodotasks.R;
import com.example.mytodotasks.adapter.TaskAdapter;
import com.example.mytodotasks.bottomSheetFragment.CreateTaskBottomSheetFragment;
import com.example.mytodotasks.bottomSheetFragment.ShowCalendarViewBottomSheet;
import com.example.mytodotasks.broadCastReceiver.AlarmBroadcastReceiver;
import com.example.mytodotasks.database.DatabaseClient;
import com.example.mytodotasks.model.Task;
...
public class MainActivity extends BaseActivity implements CreateTaskBottomSheetFragment.setRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(getApplicationContext()).load(R.drawable.notes).into(noDataImage);
